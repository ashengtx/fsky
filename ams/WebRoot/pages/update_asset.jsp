					...
					<div class="col-lg-offset-2 col-lg-8 col-lg-offset-2">
						<div class="panel panel-primary">
							...
							<div class="panel-body">
								<div class="row">
									<div class="col-lg-12">
										<s:form action="updateAsset.action">
													...
													<div class="col-lg-4">
														...
														<div class="form-group">
															...
															<label>资产类别id</label> <input class="form-control"
																...
																value="<s:property value="asset.assetclassByAssetclassid.assetclassid"/>" />
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<label>保管人id</label> <input class="form-control"
																...
																value="<s:property value="asset.userinformationByUserid.userid"/>" />
														</div>
														<div class="form-group">

															<label>财务入账人id</label> <input class="form-control"
																type="text" name="cwuid"
																value="<s:property value="asset.userinformationByCwuid.userid"/>" />
														</div>
														<div class="form-group">
															<label>上级资产类别id</label> <input class="form-control"
																type="text" name="passetclassid"
																value="<s:property value="asset.assetclassByPassetclassid.assetclassid"/>" />
														</div>
														<div class="form-group">
