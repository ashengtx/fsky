...
<body>
	...
	<div id="page-wrapper">
		...
		<form class="form-horizontal" action="#" onSubmit="return false;">
			<fieldset class="search-fieldset">
				...
				<div class="col-xs-12 no-padder">
					...
					<div class="col-gl-4">
						<span class="item_name" style="width:120px;">资产类别名称：</span> 
						<input type="text" class="textbox textbox_150" name="assetclassname"
							id="assetclassname" />
					</div>
		...
		<table class="table table-striped m-b-none" id="asset_table">
			...
			<thead>
				<tr>
					<th width="15%">资产类别id</th>
					<th width="15%">资产类别编码</th>
					<th width="15%">资产类别名称</th>
					<th width="15%">上级i资产类别id</th>
					<th width="15%">上级i资产类型名称</th>
					<th width="15%">操作</th>
				</tr>
			</thead>
			<tfoot>
	...
	<script type="text/javascript" src="../js/assettable.js"></script>
</body>
</html>
